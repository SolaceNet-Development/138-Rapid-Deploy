...
class ThirdwebService {
  ...
  async deployNFTCollection(name: string, symbol: string, description: string) {
    try {
      if (!this.sdk) throw new Error('SDK not initialized');
  ...
  async deployMarketplace(name: string, platformFee: number) {
    try {
      if (!this.sdk) throw new Error('SDK not initialized');
  ...
  async mintToken(contractAddress: string, amount: string, recipient: string) {
    try {
      if (!this.sdk) throw new Error('SDK not initialized');
  ...
  async mintNFT(contractAddress: string, metadata: any, recipient: string) {
    try {
      if (!this.sdk) throw new Error('SDK not initialized');
  ...
  async buyListing(marketplaceAddress: string, listingId: string, quantity: number) {
    try {
      if (!this.sdk) throw new Error('SDK not initialized');
